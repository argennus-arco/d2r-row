...
const runeWords = [
	...
	{ name: "권위 (Authority)", alias: ["어소리티"], runes: ["헬", "샤엘", "랄"], level: 29, sockets: 3, types: [ITEM_TYPES.ARMOR], effects: "타격 시 10% 확률로 15레벨 독기 사슬 시전, 피격 시 2% 확률로 10레벨 정신 결계 시전, 악마술사 기술 +2, 타격 회복 속도 +20%, 피해 +40-60% 증가, 착용 조건 -15%, 화염 저항 +30%" },
	    ...
	    { name: "경계 (Vigilance)", alias: ["비질란스", "비질런스"], runes: ["돌", "굴"], level: 53, sockets: 2, types: [ITEM_TYPES.SHIELD, ITEM_TYPES.PALADIN_SHIELD], effects: "피격 시 5% 확률로 10레벨 화염 고리 시전, 달리기/걷기 속도 +10%, 마법 피해 3-5 추가, +1 화염 고리 (악마술사 전용), +1 죽음의 징표 (악마술사 전용), 방어력 +92% 증가, 생명력 +21, 생명력 회복 +7, 마나 +32, 최대 독 저항 +5%, 모든 저항 +29" },
	    ...
	    { name: "의식 (Ritual)", alias: ["리추얼"], runes: ["앰", "샤엘", "오움"], level: 57, sockets: 3, types: [ITEM_TYPES.DAGGER], effects: "피격 시 13% 확률로 1레벨 인장: 죽음 시전, 공격 속도 +40%, 피해 +256% 증가, 명중률 보너스 +218%, 적중당 생명력 7% 훔침, 처치한 괴물이 안식에 듦, 적 처치 시 생명력 +3" },
	    ...
	    { name: "공허 (Void)", alias: ["보이드"], runes: ["주울", "조드", "이스트"], level: 69, sockets: 3, types: [ITEM_TYPES.DAGGER], effects: "파괴 불가, 모든 기술 +2, 시전 속도 +40%, 냉기 피해 3-14 추가, 마법 기술 피해 +10-15%, +1-3 심연 (악마술사 전용), 모든 능력치 +8-12, 매직 아이템 발견 확률 30% 증가, 4레벨 노화(충전 35회)" },
];