...
const runeWords = [
        ...
        // === Level 69 ===
        { name: "죽어가는 자의 숨결 (Breath of the Dying)", alias: ["죽숨", "브레스오브더다잉", "BOTD"], runes: ["벡스", "헬", "엘", "엘드", "조드", "에드"], level: 69, sockets: 6, types: CATEGORIES.WEAPON_ALL, note: "에테리얼 재료 권장 (파괴 불가)", effects: "적 처치 시 50% 확률로 20레벨 맹독 확산 시전, 파괴 불가, 공격 속도 +60%, 피해 +350-400% 증가, 대상의 방어력 -25%, 명중률 +50, 언데드에게 주는 피해 +200%, 언데드에 대한 명중률 +50, 적중당 마나 7% 훔침, 적중당 생명력 12-15% 훔침, 괴물 회복 저지, 모든 능력치 +30, 시야 +1, 착용 조건 -20%" },
