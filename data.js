...
const runeWords = [
        ...
        { name: "신성한 천둥 (Holy Thunder)", alias: ["홀리썬더", "신성한 번개"], runes: ["에드", "랄", "오르트", "탈"], level: 21, sockets: 4, types: [ITEM_TYPES.SCEPTER], effects: "피해 +60% 증가, 최대 피해 +10, 대상의 방어력 -25%, 화염 피해 5-30 추가, 번개 피해 21-110 추가, 독 피해 +75 (5초에 걸처), +3 신성한 충격 (성기사 전용), 최대 번개 저항 +5%, 번개 저항 +60%, 7레벨 연쇄 번개 (충전 60회)" },
        ...
        // === Level 27 ===
        { name: "통찰 (Insight)", alias: ["통찰력", "인사이트"], runes: ["랄", "티르", "탈", "솔"], level: 27, sockets: 4, types: [ITEM_TYPES.POLEARM, ITEM_TYPES.MISSILE], note: "2.4 패치부터 활/쇠뇌 제작 가능", effects: "장착 시 12-17레벨 명상 오라 효과 적용, 시전 속도 +35%, 피해 +200-260% 증가, 최소 피해 +9, 명중률 보너스 180-250%, 화염 피해 5-30 추가, 독 피해 +75 (5초에 걸쳐), +1-6 치명타, 모든 능력치 +5, 적 처치 시 마나 +2, 매직 아이템 발견 확률 23% 증가" },
        ...
        { name: "영원 (Eternity)", alias: ["이터니티", "불멸"], runes: ["앰", "베르", "이스트", "솔", "수르"], level: 63, sockets: 5, types: CATEGORIES.WEAPON_4_SOCKETS_PLUS, effects: "파괴 불가, 피해 +260-310% 증가, 최소 피해 +9, 적중당 생명력 7% 훔침, 강타 확률 +20%, 적중 시 대상 실명, 대상 감속 33%, 마나 재생 16%, 생명력 회복 +16, 빙결되지 않음, 매직 아이템 발견 확률 30% 증가, 8레벨 부활(충전 88회)" },
