...
const runeWords = [
        ...
        { name: "부 (Wealth)", alias: ["웰쓰"], runes: ["렘", "코", "티르"], level: 43, sockets: 3, types: [ITEM_TYPES.ARMOR], effects: "민첩 +10, 적 처치 시 마나 +2, 괴물에게서 얻는 금화 300% 증가, 마법 아이템 발견 확률 100% 증가" },
        ...
        { name: "초승달 (Crescent Moon)", alias: ["크레센트문"], runes: ["샤엘", "우움", "티르"], level: 47, sockets: 3, types: [ITEM_TYPES.SWORD, ITEM_TYPES.AXE, ITEM_TYPES.POLEARM], note: "⚠️ 철퇴(Mace) 제작 불가", effects: "타격 시 10% 확률로 17레벨 연쇄 번개 시전, 타격 시 7% 확률로 13레벨 전자기장 시전, 공격 속도 +20%, 피해 +180-220% 증가, 대상의 방어력 무시, 적의 번개 저항 -35%, 상처 악화 확률 +25%, 마법 흡수 +9-11, 적 처치 시 마나 +2, 18레벨 영혼 늑대 소환(충전 30회)" },
        ...
        { name: "신중 (Prudence)", alias: ["프루던스", "현명"], runes: ["말", "티르"], level: 49, sockets: 2, types: [ITEM_TYPES.ARMOR], note: "에테리얼 갑옷에 큐빙 후 제작 추천 (파괴불가 없음, 내구 회복 있음)", effects: "타격 회복 속도 +25%, 방어력 +140-170% 증가, 모든 저항 +25-35, 피해 3 감소, 마법 피해 17 감소, 적 처치 시 마나 +2, 시야 +1, 내구도 1 회복(4초마다)" },
        ...
        // === Level 51 ===
        { name: "착란 (Delirium)", alias: ["대표위원", "델리리움"], runes: ["렘", "이스트", "이오"], level: 51, sockets: 3, types: [ITEM_TYPES.HELM, ITEM_TYPES.DRUID_PELT], effects: "피격 시 1% 확률로 50레벨 착란 시전, 피격 시 6% 확률로 14레벨 정신 폭발 시전, 피격 시 14% 확률로 13레벨 공포 시전, 타격 시 11% 확률로 18레벨 혼란 시전, 모든 기술 +2, 방어 +261, 활력 +10, 괴물에게서 얻는 금화 50% 증가, 마법 아이템 발견 확률 25% 증가, 17레벨 유혹 (충전 60회)" },
        ...
        // === Level 55 ===
        { name: "침묵 (Silence)", alias: ["사일런스"], runes: ["돌", "엘드", "헬", "이스트", "티르", "벡스"], level: 55, sockets: 6, types: CATEGORIES.WEAPON_ALL, effects: "모든 기술 +2, 공격 속도 +20%, 타격 회복 속도 +20%, 피해 +200% 증가, 언데드에게 주는 피해 +75%, 언데드에 대한 명중률 +50, 적중당 마나 11% 훔침, 적중 시 대상 실명 +33, 적중 시 괴물 도주 +25%, 모든 저항 +75, 적 처치 시 마나 +2, 마법 아이템 발견 확률 30% 증가, 착용 조건 -20%" },
        ...
        // === Level 57 ===
        { name: "소집 (Call to Arms)", alias: ["콜투", "콜투암스", "CTA"], runes: ["앰", "랄", "말", "이스트", "오움"], level: 57, sockets: 5, types: CATEGORIES.WEAPON_ALL, note: "크리스탈 소드/프레일 작을 많이 함", effects: "모든 기술 +1, 공격 속도 +40%, 피해 +250~290% 증가, 화염 피해 5-30 추가, 적중당 생명력 7% 훔침, +2~6 전투 명령, +1~6 전투 지시, +1~4 전투의 함성, 괴물 회복 저지, 생명력 회복 +12, 마법 아이템 발견 확률 30% 증가" },
        ...
        { name: "추방 (Exile)", alias: ["망명", "엑자일"], runes: ["벡스", "오움", "이스트", "돌"], level: 57, sockets: 4, types: [ITEM_TYPES.SHIELD, ITEM_TYPES.PALADIN_SHIELD], subType: "성기사 전용", note: "에테리얼 전용 방패 필수 (내구 회복)", effects: "타격 시 15% 확률로 5레벨 생명력 추출 시전, 장착 시 13~16레벨 인내 오라 효과 적용, 공격 오라 +2 (성기사 전용), 막기 속도 +30%, 대상 빙결, 방어력 +220~260% 증가, 생명력 회복 +7, 최대 냉기 저항 +5%, 최대 화염 저항 +5%, 마법 아이템 발견 확률 25% 증가, 내구도 1 회복(4초마다)" },
        ...
        { name: "영원 (Eternity)", alias: ["이터니티", "불멸"], runes: ["앰", "베르", "이스트", "솔", "수르"], level: 63, sockets: 5, types: CATEGORIES.MELEE, effects: "파괴 불가, 피해 +260~310% 증가, 최소 피해 +9, 적중당 생명력 7% 훔침, 강타 확률 +20%, 적중 시 대상 실명, 대상 감속 33%, 마나 재생 16%, 생명력 회복 +16, 빙결되지 않음, 마법 아이템 발견 확률 30% 증가, 8레벨 부활(충전 88회)" },
